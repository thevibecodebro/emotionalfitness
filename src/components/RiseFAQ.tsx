    ...
    <section id="faq" className="py-20 bg-black">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto">
          <Accordion type="single" collapsible className="bg-muted/20 rounded-lg overflow-hidden p-1">
            {faqItems.map((item, index) => (
              ...
              >
                <AccordionTrigger className="text-white hover:text-red-500 py-5 px-4 text-left font-medium transition-all">
                  {item.question}
                </AccordionTrigger>
        ...
        <div className="mt-12 text-center">
          ...
          <a 
            href="#contact" 
            className="text-red-500 hover:text-orange-500 transition-colors font-medium"
          >
