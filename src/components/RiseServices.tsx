...
const services = [
  {
    ...
    icon: <Sparkles className="w-12 h-12 text-red-500 stroke-[1.5px]" />
  },
  {
    title: "Optimization",
    ...
    icon: <Lightbulb className="w-12 h-12 text-orange-500 stroke-[1.5px]" />
  },
  {
    title: "Passion",
    ...
    icon: <Flame className="w-12 h-12 text-red-600 stroke-[1.5px]" />
  },
  {
    title: "Drive",
    ...
    icon: <Compass className="w-12 h-12 text-orange-600 stroke-[1.5px]" />
  }
];
  ...
  return (
    <section id="services" className="py-20 bg-black">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center gradient-text-rise">Our Services</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, index) => (
            <Card key={index} className="bg-muted border-none p-6 hover:bg-muted/80 transition-colors" style={{
