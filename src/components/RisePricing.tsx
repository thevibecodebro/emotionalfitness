...
const PricingCard = ({ 
  ...
  return (
    <div className={`relative bg-muted/20 rounded-xl p-8 border ${popular ? 'border-orange-500' : 'border-white/10'} h-full flex flex-col`}>
      {popular && (
        <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-red-600 to-orange-500 text-white text-xs font-bold py-1 px-3 rounded-full">
          MOST POPULAR
        </div>
      )}
      ...
      <div className="mt-auto pt-4">
        <Button 
          className={`w-full ${popular ? 'bg-gradient-to-r from-red-600 to-orange-500 hover:from-orange-500 hover:to-red-600' : 'bg-white/10 hover:bg-white/20'} transition-all`}
  ...
  return (
    <section id="pricing" className="py-20 bg-black">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center gradient-text-rise">
